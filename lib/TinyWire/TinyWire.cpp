...
uint8_t TinyTwi::write(uint8_t data) { return send(data); }

uint8_t TinyTwi::read() { return Twi_receive(); }

uint8_t TinyTwi::receive() { return read(); }

uint8_t TinyTwi::available() { return Twi_available(); }
...
void TinyTwi::onReceive(void (*function)(int)) { user_onReceive = function; }

void TinyTwi::onRequest(void (*function)(void)) { user_onRequest = function; }
